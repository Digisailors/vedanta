      ...
      <div className="relative h-[40rem]  overflow-hidden">
        <AnimatePresence initial={false}>
          ...
          >
            ...
            <motion.div
              className={`absolute inset-0 flex flex-col justify-center ${getPositionClass(
                currentIndex
              )}`}
            ...
            >
              <div className="px-20">
                <h1 className="text-4xl text-white font-bold text-center">
                  ...
                  <span className="relative inline-block">&nbsp;service</span>
                </h1>
                <p className="text-lg text-white mt-2 text-center">
                  We are the best guaranteed company to serve you.
                  <br /> We are dedicated to help you any time.
                </p>
                <motion.div
                  className={`mt-4 ${
                    currentIndex % 3 === 1
