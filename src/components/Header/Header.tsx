  ...
  return (
    <>
      <div className="relative w-full">
        ...
        <div
          className={`flex w-full h-14 items-center z-10 justify-between px-7 transition-all duration-300 ${
            isSticky ? "fixed top-0 left-0 right-0 " : "absolute -bottom-7"
          }`}
        >
          {" "}
        ...
        <Modal isOpen={isOpen} onClose={toggleMenu}>
          <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            >
              ...
              <nav className="text-white">{renderNavItems(true)}</nav>
            </div>
          </div>
        </Modal>
      )}
